...
async function main() {
  ...
  const users = [
    { id: "u-jack",    name: "Jack",          email: "jack@jackstudio.my",    password: pw, role: "admin",   outletId: null          },
    { id: "u-jason",   name: "Jason Lim",     email: "jason@jackstudio.my",   password: pw, role: "sales",   outletId: "kl-flagship" },
    { id: "u-amirul",  name: "Amirul H.",     email: "amirul@jackstudio.my",  password: pw, role: "sales",   outletId: "pavilion"    },
    { id: "u-ali",     name: "Ali Haikal",    email: "ali@jackstudio.my",     password: pw, role: "creator", outletId: "tiktok"      },
    { id: "u-nurul",   name: "Nurul Ain",     email: "nurul@jackstudio.my",   password: pw, role: "creator", outletId: "tiktok"      },
    { id: "u-siti",    name: "Siti Maryam",   email: "siti@jackstudio.my",    password: pw, role: "creator", outletId: "ig"          },
    { id: "u-rachel",  name: "Rachel Tan",    email: "rachel@jackstudio.my",  password: pw, role: "product", outletId: null          },
    { id: "u-hafiz",   name: "Hafiz Z.",       email: "hafiz@jackstudio.my",  password: pw, role: "sales",   outletId: "sunway"      },
    { id: "u-meiling", name: "Mei Ling",      email: "meiling@jackstudio.my", password: pw, role: "sales",   outletId: "penang-gurney"},
    { id: "u-kumar",   name: "Kumar S.",      email: "kumar@jackstudio.my",   password: pw, role: "sales",   outletId: "jb-city-sq"  },
    { id: "u-klmgr",   name: "Store KL Mgr", email: "klmgr@jackstudio.my",   password: pw, role: "manager", outletId: "kl-flagship" },
  ];
  ...
  const products = [
    {
      id: "p1", name: 'Cabin Luggage 20"', category: "Luggage",
      status: "Testing", stage: "Bullet", hitRate: 68,
      signalSource: "Creator + Sales", decisionDate: "2026-04-14",
      notes: "Strong demand from creator comments. Small batch ordered.",
      tasks: JSON.stringify(["Creator content x3", "Shopee listing", "Store display"]),
    },
    {
      id: "p2", name: "Slim Wallet (Brown)", category: "Leather Goods",
      status: "Scale", stage: "Cannonball", hitRate: 91,
      signalSource: "TikTok viral", decisionDate: "2026-04-07",
      notes: "Exceeded test target. Push inventory x3.",
      tasks: JSON.stringify(["Increase stock", "Bundle deal", "All channels"]),
    },
    {
      id: "p3", name: "Crossbody Tote", category: "Bags",
      status: "Watchlist", stage: "Bullet", hitRate: 0,
      signalSource: "Customer Input + Creator", decisionDate: null,
      notes: "Multiple signals received. Pending sourcing.",
      tasks: JSON.stringify(["Find supplier", "Sample review"]),
    },
    {
      id: "p4", name: "Canvas Backpack", category: "Bags",
      status: "Eliminated", stage: "Bullet", hitRate: 18,
      signalSource: "Internal idea", decisionDate: "2026-03-21",
