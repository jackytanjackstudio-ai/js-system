...
export async function GET() {
  ...
  const outlets = [
    // Physical — active
    { id: "kl-flagship",   name: "BERJAYA TIME SQUARE",  city: "Kuala Lumpur",  type: "physical", isActive: true  },
    { id: "midvalley",     name: "AEON BUKIT TINGGI",    city: "KLANG",         type: "physical", isActive: true  },
    { id: "utama",         name: "PARADIGM MALL",        city: "Petaling Jaya", type: "physical", isActive: true  },
    { id: "ioicity",       name: "ALAMANDA",             city: "Putrajaya",     type: "physical", isActive: true  },
    { id: "pj-ss2",        name: "AEON PERMAS JAYA",     city: "JOHOR BHARU",   type: "physical", isActive: true  },
    { id: "kuantan",       name: "EAST COAST MALL",      city: "Kuantan",       type: "physical", isActive: true  },
    { id: "jb-city-sq",    name: "AEON BUKIT INDAH",     city: "Johor Bahru",   type: "physical", isActive: true  },
    { id: "jb-paradigm",   name: "AEON KULAI JAYA",      city: "Johor Bahru",   type: "physical", isActive: true  },
    { id: "melaka-dp",     name: "AEON ALPHA ANGLE",     city: "WANGSA MAJU",   type: "physical", isActive: true  },
    { id: "seremban",      name: "AEON SEREMBAN 2",      city: "Seremban",      type: "physical", isActive: true  },
    { id: "da-men",        name: "MAIN PLACE",           city: "USJ",           type: "physical", isActive: true  },
    { id: "alor-setar",    name: "MAYANG MALL",          city: "TERRENGGANU",   type: "physical", isActive: true  },
    { id: "penang-e-gate", name: "SUNWAY CARNIVAL MALL", city: "Penang",        type: "physical", isActive: true  },
    // Physical — inactive
    { id: "pavilion",      name: "Pavilion KL",          city: "Kuala Lumpur",  type: "physical", isActive: false },
    { id: "sunway",        name: "Sunway Pyramid",       city: "Subang",        type: "physical", isActive: false },
    { id: "kl-sentral",    name: "KL Sentral",           city: "Kuala Lumpur",  type: "physical", isActive: false },
    { id: "ipoh-parade",   name: "Ipoh Parade",          city: "Ipoh",          type: "physical", isActive: false },
    { id: "penang-gurney", name: "Gurney Plaza",         city: "Penang",        type: "physical", isActive: false },
    { id: "kota-bharu",    name: "KB Mall",              city: "Kota Bharu",    type: "physical", isActive: false },
    { id: "setia-city",    name: "Setia City Mall",      city: "Shah Alam",     type: "physical", isActive: false },
    // Online
    { id: "shopee",   name: "Shopee",      city: "Online", type: "online", channelKey: "shopee",   isActive: true },
    { id: "lazada",   name: "Lazada",      city: "Online", type: "online", channelKey: "lazada",   isActive: true },
    { id: "tiktok",   name: "TikTok Shop", city: "Online", type: "online", channelKey: "tiktok",   isActive: true },
    { id: "website",  name: "Website",     city: "Online", type: "online", channelKey: "website",  isActive: true },
    { id: "facebook", name: "Facebook",    city: "Online", type: "online", channelKey: "facebook", isActive: true },
    { id: "ig",       name: "Instagram",   city: "Online", type: "online", channelKey: "ig",       isActive: true },
    { id: "rednote",  name: "Rednote",     city: "Online", type: "online", channelKey: "rednote",  isActive: true },
    { id: "whatsapp", name: "WhatsApp",    city: "Online", type: "online", channelKey: "whatsapp", isActive: true },
  ];
  for (const { isActive, ...data } of outlets) {
    await prisma.outlet.upsert({
      where:  { id: data.id },
      update: { name: data.name, city: data.city, isActive },
      create: { ...data, isActive },
    });
  }
