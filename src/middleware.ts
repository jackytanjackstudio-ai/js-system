...
const PUBLIC_PATHS = ["/login", "/register", "/api/auth/login", "/api/auth/register", "/api/inputs", "/api/outlets/", "/api/outlets/public", "/api/admin/seed-outlets", "/api/admin/init", "/api/admin/fix-outlets"];
